...
public:
    ...
    float x() const { return m_Value[0]; }
    float y() const { return m_Value[1]; }
...
public:
    ...
    bounds2d_t(const vec2_t &vecUpperLeftCorner, const vec2_t &vecUpperRightCorner, const vec2_t &vecLowerLeftCorner, const vec2_t &vecLowerRightCorner);
